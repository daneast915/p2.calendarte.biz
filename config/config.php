...
# What is the name of this app?
	define('APP_NAME', "Calend'Arte");  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'daneast915@gmail.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'daneast915@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'calendar_p2_calendarte_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'asdlkhwelkqwerqlwekjrwlkjwjrexcvbmnxcvbs');
	define('TOKEN_SALT',    'lkalsdjhfalskdjlaksdjhfalfhdwpoiuyweryqw');